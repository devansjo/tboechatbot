...
config :tboechatbot, Tboechatbot.Endpoint,
  ...
  url: [host: "infinite-brushlands-15789.herokuapp.com", port: 443],
...
# start per endpoint:
#
#     config :tboechatbot, Tboechatbot.Endpoint, server: true
#
# You will also need to set the application root to `.` in order
# for the new static assets to be served after a hot upgrade:
#
#     config :tboechatbot, Tboechatbot.Endpoint, root: "."
...
# Configure Smooch.IO
config :tboechatbot,
    smooch_key: System.get_env("SMOOCH_KEY"),
    smooch_secret: System.get_env("SMOOCH_SECRET"),
